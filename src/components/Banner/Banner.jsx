...
const Banner = () => {
  return (
    <div>
      ...
      <div className="px-4 py-20 bg-linear-brand grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-0 items-center">
        <div className="border-base-200 border-b-2 md:border-b-0 md:border-r-2 text-center pb-10 md:pb-0">
          <h1 className="text-5xl md:text-6xl font-black text-white ">50K+</h1>
        ...
        <div className="border-base-200 border-b-2 md:border-b-0 md:border-r-2 text-center pb-10 md:pb-0">
          <h1 className="text-5xl md:text-6xl font-black text-white ">200+</h1>
          <p className="text-white/80 font-semibold text-lg mt-2">
            Premium Tools
          </p>
        </div>
        ...
        <div className="text-center">
          <h1 className="text-5xl md:text-6xl font-black text-white ">4.9</h1>
          <p className="text-white/80 font-semibold text-lg mt-2">Avg Rating</p>
        </div>
      </div>
    </div>
  );
