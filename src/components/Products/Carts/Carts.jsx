        ...
        <div id='cart-section'>
            ...
            {selectedCart.length === 0 ? (
                <div className="text-center py-20">
                    <h2 className="text-2xl font-bold text-gray-400">No Carts Selected</h2>
                </div> 
            ) : (
                
                <div className='container mx-auto px-6 md:px-10 border-2 border-slate-100 rounded-3xl py-10 shadow-sm bg-white'>
                    <h2 className='font-bold text-3xl md:text-4xl mb-8 text-slate-800'>Your Cart</h2>
